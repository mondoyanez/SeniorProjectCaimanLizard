...
VALUES
(1, 'SandraHart', 'Sandra', 'Hart', 'SandraHart@email.com', 0, 0, NULL),
(2, 'CarsonDaniel', 'Carson', 'Daniel', 'DanielCarson@domain.net', 0, 0, NULL),
(3, 'PaigeCole', 'Paige', 'Cole', null, 0, 0, NULL),
(4, 'JaysonLawrence', 'Jayson', 'Lawrence', 'jLawrence@name.edu', 0, 0, NULL),
(5, 'GabrielGrant', 'Gabriel', 'Grant', 'gGabriel@differentMail.com', 0, 0, NULL),
(6, 'BradPorter', 'Brad', 'Porter', 'BradPorter@email.com', 0, 0, NULL),
(7, 'JudsonCooke', 'Judson', 'Cooke', null, 0, 0, NULL),
(8, 'SofiaCarpenter', 'Sofia', 'Carpenter', 'CarpenterSofia@mail.org', 0, 0, NULL),
(9, 'JosefMeyer', 'Josef', 'Meyer', 'JosefMeyer@mail.edu', 0, 0, NULL),
(10, 'BobbieMcintyre', 'Bobbie', 'Mcintyre', null, 0, 0, NULL);
