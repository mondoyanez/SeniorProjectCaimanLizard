...
public partial class WatchPartyDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Comment__3214EC270DECAEEE");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Followin__3214EC27E19A11BA");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__LikePost__3214EC27A9467285");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Movie__3214EC275B3D207F");
        });

        modelBuilder.Entity<Notification>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Notifica__3214EC279AB6741E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Notifica__3214EC27ABF4E54E");
        });

        modelBuilder.Entity<Post>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Post__3214EC27F48F0990");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Reshare__3214EC27EA7FCBAC");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Show__3214EC276BFF5F87");
        });

        modelBuilder.Entity<WatchList>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__WatchLis__3214EC270454509C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__WatchLis__3214EC2795BBC388");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__WatchPar__3214EC272C6756E9");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__WatchPar__3214EC27F5F55801");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Watcher__3214EC071615742D");
        });
