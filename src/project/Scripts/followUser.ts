const followButton: JQuery<HTMLElement> = $("#user-profile-btn-follow");
const unfollowButton: JQuery<HTMLElement> = $("#user-profile-following-icon");

followButton.on("click", (e: JQuery.Event) => {
    e.preventDefault();
...
unfollowButton.on("click", (e: JQuery.Event) => {
    e.preventDefault();
    const followerUsername = $("#user-profile-username").val();
