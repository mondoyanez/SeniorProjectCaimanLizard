...
namespace WatchParty_BDD_Tests.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("CLD199_RemoveWatchParty")]
    [NUnit.Framework.CategoryAttribute("Armando_Yanez")]
    [NUnit.Framework.CategoryAttribute("LoggedIn")]
    public partial class CLD199_RemoveWatchPartyFeature
    {
...
#line 1 "CLD199_RemoveWatchParty.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "CLD199_RemoveWatchParty", @"**As a user, I would like the ability to remove users' from my Watch Party Group if I add someone to my group by mistake of
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Users cannot remove other users from watch party group")]
        ...
        public virtual void UsersCannotRemoveOtherUsersFromWatchPartyGroup(string firstName, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("FirstName", firstName);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Users cannot remove other users from watch party group", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 18
